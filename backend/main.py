...
# HubSpot
# we will get auth_url from this request to which we will get the account to login , this will open in the ui
...
# Retrieves HubSpot credentials for a user and organization. The HubSpot credentials.
...
# getting the list of companies listed from the client id we are using here
